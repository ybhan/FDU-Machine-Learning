...
tf.flags.DEFINE_string('X_input_dir', 'C:\\Users\\new\\Desktop\\a',
                       'X input directory, default: data/apple2orange/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'C:\\Users\\new\\Desktop\\b',
                       'Y input directory, default: data/apple2orange/trainB')
tf.flags.DEFINE_string('X_output_file', 'C:\\Users\\new\\Desktop\\c',
                       'X output tfrecords file, default: data/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'C:\\Users\\new\\Desktop\\d',
...
def data_reader(input_dir, shuffle=True):
    ...
    if shuffle:
        # Shuffle the ordering of all image files in order to guarantee random
        # ordering of the images with respect to label in the saved TFRecord
        # files. This makes the randomization repeatable.
