...
tf.flags.DEFINE_string('checkpoint_dir', 'checkpoints/20180204-1600', 'checkpoints/20180204-1203')
tf.flags.DEFINE_string('XtoY_model', 'man2woman.pb', 'XtoY model name, default: apple2orange.pb')
tf.flags.DEFINE_string('YtoX_model', 'woman2man.pb', 'YtoX model name, default: orange2apple.pb')
